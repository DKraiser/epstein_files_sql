...
In this project downloaded data are: 

- `data/documents/documents-00000-of-00015.parquet` (saved as `data/documents.parquet`)
- `data/chunks/chunks-00000-of-00011.parquet` (saved as `data/chunks.parquet`)

Data were accessed from repository `kabasshouse/epstein-data`, branch `main`, commit `133ef9f0a539fafc270cde8fa8638dc38d89968d` and downloaded via link.
